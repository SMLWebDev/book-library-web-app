<template>
  <div>
    ...
    <div v-if="loading" class="text-center py-8">
      <div class="text-gray-500">Loading your reading list...</div>
    </div>

    <div v-else-if="toReadBooks.length === 0" class="text-center py-12">
      <div class="text-gray-500 mb-4">Your reading list is empty.</div>
      <RouterLink 
        to="/" 
...
const { toReadBooks, loading } = storeToRefs(bookStore)
